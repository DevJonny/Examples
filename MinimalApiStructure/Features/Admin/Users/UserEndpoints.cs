using MinimalApiStructure.Features.Admin.Users.CreateUser;
using MinimalApiStructure.Features.Admin.Users.GetAll;
using Paramore.Brighter;
using Paramore.Darker;

namespace MinimalApiStructure.Features.Admin.Users;
